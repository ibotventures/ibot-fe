...
const MyComponent = () => {
    ...
    const renderContent = () => {
        ...
        switch (selectedTask) {
            case 'delete':
                return <div className='container-fluid'><Delete /></div>;
            case 'courses':
            ...
            case 'edit':
                return <div><EditDetails upadteuser={upadteuser} setuser={setuser} updateprofile={updateprofile} setprofile={setprofile} /></div>;
            default:
                return <p>Unknown task type.</p>;
        }
    };
            ...
            <Container fluid>
                ...
                >
                    <div style={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
                        <br />
                        <br />
                        <Image width={160} height={170} src={updateprofile || '/profile.png'} className="img-fluid" alt="Profile Image" style={{ borderRadius: "50%", objectFit: "cover", width: "130px", height: "130px" }} unoptimized />
                        <p>{upadteuser}</p>
                    </div>
                    {/* Sidebar links */}
                    <div style={{ display: 'flex', gap: '10px' }}>
                    ...
                    <div style={{ display: 'flex', gap: '10px' }}>
                        <AiOutlineUser size={20} color="grey" title="Edit Details" />
                        <p onClick={() => { handleTaskClick('edit'); setSidebarOpen(!sidebarOpen) }} style={{ fontSize: '18px', cursor: 'pointer' }}>Edit Profile</p>
                    </div>
                    <div style={{ display: 'flex', gap: '10px' }}>
                        <MdDeleteForever size={20} color="grey" title="Delete" />
                        <p onClick={() => { handleTaskClick('delete'); setSidebarOpen(!sidebarOpen) }} style={{ fontSize: '18px', cursor: 'pointer' }}>Delete Account</p>
                    </div>
                </Offcanvas>
                {/* Main content */}
